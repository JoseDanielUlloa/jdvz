...
final class TabActivation extends Tab {
	...
	public function render_form() {
        ...
        <div class="mdp-activation-form">
            <h3><?php esc_html_e( 'Plugin Activation', 'readabler' ); ?></h3>
            <?php
            ...
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <div class="mdc-accordion-content">
                    <p><?php esc_html_e( 'The purchase code is a unique combination of characters that confirms that you bought the plugin. You can find your purchase code in ', 'readabler' ); ?>
                        <a href="https://1.envato.market/cc-downloads" target="_blank"><?php esc_html_e( 'your account', 'readabler' );?></a>
                        <?php esc_html_e( ' on the CodeCanyon. Learn more about ', 'readabler' ); ?>
                ...
                <div class="mdc-accordion-content">
                    <p>
                        ...
                        <a href="https://1.envato.market/KYbje" target="_blank"><?php esc_html_e( 'Envato License', 'readabler' );?></a>
                        <?php esc_html_e( ' terms. ', 'readabler' ); ?>
                    </p>
                </div>
