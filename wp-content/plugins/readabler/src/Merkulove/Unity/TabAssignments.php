...
final class TabAssignments extends Tab  {
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_readabler_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <div class="mdp-os-box">
                        ...
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php esc_html_e( 'Windows (All)', 'readabler' ); ?></option>
                            <option value="Windows nt 10.0"><?php esc_html_e( 'Windows 10', 'readabler' ); ?></option>
                            <option value="Windows nt 6.2"><?php esc_html_e( 'Windows 8', 'readabler' ); ?></option>
                            <option value="Windows nt 6.1"><?php esc_html_e( 'Windows 7', 'readabler' ); ?></option>
                            <option value="Windows nt 6.0"><?php esc_html_e( 'Windows Vista', 'readabler' ); ?></option>
                            <option value="Windows nt 5.2"><?php esc_html_e( 'Windows Server 2003', 'readabler' ); ?></option>
                            <option value="Windows nt 5.1"><?php esc_html_e( 'Windows XP', 'readabler' ); ?></option>
                            <option value="Windows nt 5.01"><?php esc_html_e( 'Windows 2000 sp1', 'readabler' ); ?></option>
                            <option value="Windows nt 5.0"><?php esc_html_e( 'Windows 2000', 'readabler' ); ?></option>
                            <option value="Windows nt 4.0"><?php esc_html_e( 'Windows NT 4.0', 'readabler' ); ?></option>
                            <option value="Win 9x 4.9"><?php esc_html_e( 'Windows Me', 'readabler' ); ?></option>
                            <option value="Windows 98"><?php esc_html_e( 'Windows 98', 'readabler' ); ?></option>
                            <option value="Windows 95"><?php esc_html_e( 'Windows 95', 'readabler' ); ?></option>
                            <option value="Windows ce"><?php esc_html_e( 'Windows CE', 'readabler' ); ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (All)', 'readabler' ); ?></option>
                            <option value="Mac OS X"><?php esc_html_e( 'Mac OSX (All)', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.11"><?php esc_html_e( 'Mac OSX El Capitan', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.10"><?php esc_html_e( 'Mac OSX Yosemite', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.9"><?php esc_html_e( 'Mac OSX Mavericks', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.8"><?php esc_html_e( 'Mac OSX Mountain Lion', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.7"><?php esc_html_e( 'Mac OSX Lion', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.6"><?php esc_html_e( 'Mac OSX Snow Leopard', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.5"><?php esc_html_e( 'Mac OSX Leopard', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.4"><?php esc_html_e( 'Mac OSX Tiger', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.3"><?php esc_html_e( 'Mac OSX Panther', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.2"><?php esc_html_e( 'Mac OSX Jaguar', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.1"><?php esc_html_e( 'Mac OSX Puma', 'readabler' ); ?></option>
                            <option value="Mac OS X 10.0"><?php esc_html_e( 'Mac OSX Cheetah', 'readabler' ); ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (classic)', 'readabler' ); ?></option>
                            <option value="#(Linux|X11)#"><?php esc_html_e( 'Linux', 'readabler' ); ?></option>
                            <option value="OpenBSD"><?php esc_html_e( 'Open BSD', 'readabler' ); ?></option>
                            <option value="SunOS"><?php esc_html_e( 'Sun OS', 'readabler' ); ?></option>
                            <option value="QNX"><?php esc_html_e( 'QNX', 'readabler' ); ?></option>
                            <option value="BeOS"><?php esc_html_e( 'BeOS', 'readabler' ); ?></option>
                            <option value="OS/2"><?php esc_html_e( 'OS/2', 'readabler' ); ?></option>
                        </select>
                    </div>
                        ...
                        <div class="mdp-widget-manager-control-box">
                            ...
                            <div>
                                ...
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php esc_html_e( 'Chrome (All)', 'readabler' ); ?></option>
                                    <option value="#Chrome/(6[1-9]|70)\.#"><?php esc_html_e( 'Chrome 61-70', 'readabler' ); ?></option>
                                    <option value="#Chrome/(5[1-9]|60)\.#"><?php esc_html_e( 'Chrome 51-60', 'readabler' ); ?></option>
                                    <option value="#Chrome/(4[1-9]|50)\.#"><?php esc_html_e( 'Chrome 41-50', 'readabler' ); ?></option>
                                    <option value="#Chrome/(3[1-9]|40)\.#"><?php esc_html_e( 'Chrome 31-40', 'readabler' ); ?></option>
                                    <option value="#Chrome/(2[1-9]|30)\.#"><?php esc_html_e( 'Chrome 21-30', 'readabler' ); ?></option>
                                    <option value="#Chrome/(1[1-9]|20)\.#"><?php esc_html_e( 'Chrome 11-20', 'readabler' ); ?></option>
                                    <option value="#Chrome/([1-9]|10)\.#"><?php esc_html_e( 'Chrome 1-10', 'readabler' ); ?></option>
                                    <option value="Firefox"><?php esc_html_e( 'Firefox (All)', 'readabler' ); ?></option>
                                    <option value="#Firefox/(6[1-9]|70)\.#"><?php esc_html_e( 'Firefox 61-70', 'readabler' ); ?></option>
                                    <option value="#Firefox/(5[1-9]|60)\.#"><?php esc_html_e( 'Firefox 51-60', 'readabler' ); ?></option>
                                    <option value="#Firefox/(4[1-9]|50)\.#"><?php esc_html_e( 'Firefox 41-50', 'readabler' ); ?></option>
                                    <option value="#Firefox/(3[1-9]|40)\.#"><?php esc_html_e( 'Firefox 31-40', 'readabler' ); ?></option>
                                    <option value="#Firefox/(2[1-9]|30)\.#"><?php esc_html_e( 'Firefox 21-30', 'readabler' ); ?></option>
                                    <option value="#Firefox/(1[1-9]|20)\.#"><?php esc_html_e( 'Firefox 11-20', 'readabler' ); ?></option>
                                    <option value="#Firefox/([1-9]|10)\.#"><?php esc_html_e( 'Firefox 1-10', 'readabler' ); ?></option>
                                    <option value="MSIE"><?php esc_html_e( 'Internet Explorer (All)', 'readabler' ); ?></option>
                                    <option value="MSIE Edge"><?php esc_html_e( 'Internet Explorer Edge', 'readabler' ); ?></option>
                                    <option value="Edge/15"><?php esc_html_e( 'Edge 15', 'readabler' ); ?></option>
                                    <option value="Edge/14"><?php esc_html_e( 'Edge 14', 'readabler' ); ?></option>
                                    <option value="Edge/13"><?php esc_html_e( 'Edge 13', 'readabler' ); ?></option>
                                    <option value="Edge/12"><?php esc_html_e( 'Edge 12', 'readabler' ); ?></option>
                                    <option value="MSIE 11"><?php esc_html_e( 'Internet Explorer 11', 'readabler' ); ?></option>
                                    <option value="MSIE 10.6"><?php esc_html_e( 'Internet Explorer 10.6', 'readabler' ); ?></option>
                                    <option value="MSIE 10.0"><?php esc_html_e( 'Internet Explorer 10.0', 'readabler' ); ?></option>
                                    <option value="MSIE 10."><?php esc_html_e( 'Internet Explorer 10', 'readabler' ); ?></option>
                                    <option value="MSIE 9."><?php esc_html_e( 'Internet Explorer 9', 'readabler' ); ?></option>
                                    <option value="MSIE 8."><?php esc_html_e( 'Internet Explorer 8', 'readabler' ); ?></option>
                                    <option value="MSIE 7."><?php esc_html_e( 'Internet Explorer 7', 'readabler' ); ?></option>
                                    <option value="#MSIE [1-6]\.#"><?php esc_html_e( 'Internet Explorer 1-6', 'readabler' ); ?></option>
                                    <option value="Opera"><?php esc_html_e( 'Opera (All)', 'readabler' ); ?></option>
                                    <option value="#Opera/(5[1-9]|60)\.#"><?php esc_html_e( 'Opera 51-60', 'readabler' ); ?></option>
                                    <option value="#Opera/(4[1-9]|50)\.#"><?php esc_html_e( 'Opera 41-50', 'readabler' ); ?></option>
                                    <option value="#Opera/(3[1-9]|40)\.#"><?php esc_html_e( 'Opera 31-40', 'readabler' ); ?></option>
                                    <option value="#Opera/(2[1-9]|30)\.#"><?php esc_html_e( 'Opera 21-30', 'readabler' ); ?></option>
                                    <option value="#Opera/(1[1-9]|20)\.#"><?php esc_html_e( 'Opera 11-20', 'readabler' ); ?></option>
                                    <option value="#Opera/([1-9]|10)\.#"><?php esc_html_e( 'Opera 1-10', 'readabler' ); ?></option>
                                    <option value="Safari"><?php esc_html_e( 'Safari (All)', 'readabler' ); ?></option>
                                    <option value="#Version/11\..*Safari/#"><?php esc_html_e( 'Safari 11', 'readabler' ); ?></option>
                                    <option value="#Version/10\..*Safari/#"><?php esc_html_e( 'Safari 10', 'readabler' ); ?></option>
                                    <option value="#Version/9\..*Safari/#"><?php esc_html_e( 'Safari 9', 'readabler' ); ?></option>
                                    <option value="#Version/8\..*Safari/#"><?php esc_html_e( 'Safari 8', 'readabler' ); ?></option>
                                    <option value="#Version/7\..*Safari/#"><?php esc_html_e( 'Safari 7', 'readabler' ); ?></option>
                                    <option value="#Version/6\..*Safari/#"><?php esc_html_e( 'Safari 6', 'readabler' ); ?></option>
                                    <option value="#Version/5\..*Safari/#"><?php esc_html_e( 'Safari 5', 'readabler' ); ?></option>
                                    <option value="#Version/4\..*Safari/#"><?php esc_html_e( 'Safari 4', 'readabler' ); ?></option>
                                    <option value="#Version/[1-3]\..*Safari/#"><?php esc_html_e( 'Safari 1-3', 'readabler' ); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mdp-widget-manager-control-box">
                            ...
                            <div>
                                ...
                                <select class="mobile-browsers chosen-select" multiple="">
                                    ...
                                    <option value="Android"><?php esc_html_e( 'Android', 'readabler' ); ?></option>
                                    <option value="#Android.*Chrome#"><?php esc_html_e( 'Android Chrome', 'readabler' ); ?></option>
                                    <option value="Blackberry"><?php esc_html_e( 'Blackberry', 'readabler' ); ?></option>
                                    <option value="IEMobile"><?php esc_html_e( 'IE Mobile', 'readabler' ); ?></option>
                                    <option value="iPad"><?php esc_html_e( 'iPad', 'readabler' ); ?></option>
                                    <option value="iPhone"><?php esc_html_e( 'iPhone', 'readabler' ); ?></option>
                                    <option value="iPod"><?php esc_html_e( 'iPod Touch', 'readabler' ); ?></option>
                                    <option value="NetFront"><?php esc_html_e( 'NetFront', 'readabler' ); ?></option>
                                    <option value="NokiaBrowser"><?php esc_html_e( 'Nokia', 'readabler' ); ?></option>
                                    <option value="Opera Mini"><?php esc_html_e( 'Opera Mini', 'readabler' ); ?></option>
                                    <option value="Opera Mobi"><?php esc_html_e( 'Opera Mobile', 'readabler' ); ?></option>
                                    <option value="UC Browser"><?php esc_html_e( 'UC Browser', 'readabler' ); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <div class="mdp-ips-box">
                        ...
                        <p>
                            ...
                            <?php esc_html_e( '46.33.233.31', 'readabler' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'readabler' ); ?><br>
                            <?php esc_html_e( '46', 'readabler' ); ?>
                        </p>
                    </div>
