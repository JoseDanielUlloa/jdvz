...
final class Settings {
	...
	private function add_submenu_elementor() {
        ...
        add_submenu_page(
            $parent,
            esc_html__( 'Readabler Settings', 'readabler' ),
            esc_html__( 'Readabler for ', 'readabler' ),
            'manage_options',
        ...
        <div class="mdc-drawer__header mdc-plugin-fixed">
            <a class="mdc-list-item mdp-plugin-title" href="#">
                <i class="mdc-list-item__graphic" aria-hidden="true">
                    <img src="<?php echo esc_attr( Plugin::get_url() . 'images/logo-color.svg' ); ?>" alt="<?php esc_html_e( 'Readabler', 'readabler' ) ?>">
                </i>
                <span class="mdc-list-item__text">
                    <?php if ( 'wordpress' === Plugin::get_type() ) : ?>
                        <?php esc_html_e( 'Readabler', 'readabler' ) ?>
                    <?php else: ?>
                        <?php esc_html_e( 'Readabler', 'readabler' ) ?>
                    <?php endif; ?>
                </span>
