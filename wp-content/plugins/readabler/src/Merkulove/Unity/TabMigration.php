...
final class TabMigration extends Tab {
    ...
    private function __construct() {
        ...
        add_action( 'wp_ajax_export_settings_readabler', [ __CLASS__, 'ajax_export_settings' ] );
        add_action( 'wp_ajax_import_settings_readabler', [ __CLASS__, 'ajax_import_settings' ] );
