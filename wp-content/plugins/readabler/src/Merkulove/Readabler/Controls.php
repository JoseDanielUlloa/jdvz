...
final class Controls {
	...
	public function render_input_spinner( $key, $title, $label, $step = 5 ) {
	    ...
	    ?>
        <div id="mdp-readabler-action-<?php esc_attr_e( $dash_key ); ?>" class="mdp-readabler-action-box mdp-readabler-spinner-box">
    ...
    private function render_toggle_button( $key, $title, $hide = false ) {
	    ...
	    ?>
        <div id="mdp-readabler-action-<?php esc_attr_e( $dash_key ); ?>"
    ...
    private function render_useful_links( $key, $title ) {
	    ...
	    ?>
        <div id="mdp-readabler-action-<?php esc_attr_e( $dash_key ); ?>" class="mdp-readabler-action-box mdp-readabler-useful-links-box">
            <div class="mdp-readabler-action-box-content">
                <label for="mdp-readabler-useful-links" class="mdp-readabler-title"><?php esc_html_e( $title ); ?></label>
                <div class="mdp-readabler-select-box">
                    <select id="mdp-readabler-useful-links" aria-label="<?php esc_html_e( 'Useful Links', 'readabler' ); ?>">
    ...
    private function render_palette( $key, $title ) {
	    ...
	    ?>
        <div id="mdp-readabler-action-<?php esc_attr_e( $dash_key ); ?>" class="mdp-readabler-action-box mdp-readabler-palette-box">
            <div class="mdp-readabler-action-box-content">
                <span class="mdp-readabler-title"><?php esc_html_e( $title ); ?></span>
                <div class="mdp-readabler-color-box">
                    <?php foreach ( $colors as $color ) : ?>
                        <span data-color="<?php esc_attr_e( $color['value'] ); ?>"
                              class="mdp-readabler-color <?php esc_attr_e( '#ffffff' === $color['value'] ? 'mdp-white' : '' ); ?>"
                              role="button"
                              tabindex="0"
                              aria-label="<?php esc_attr_e( 'Change Color to ', 'readabler' ); esc_attr_e( $color['name'] ); ?>"
                              style="background-color: <?php esc_attr_e( $color['value'] ); ?> !important;">
                        </span>
                    <?php endforeach; ?>
                </div>
            </div>
	...
	private function print_profile_switch( $key, $title, $short, $description ) {
	    ...
	    ?>
        <div id="mdp-readabler-accessibility-<?php esc_attr_e( $dash_key ); ?>" class="mdp-readabler-accessibility-profile-item" tabindex="0">
            <div class="mdp-readabler-row">
                <div class="mdp-readabler-switch-box">
                    <label class="mdp-switch">
	                    <?php esc_html_e( $title ); ?>
                        <input type="checkbox" name="mdp-readabler-accessibility-<?php esc_attr_e( $dash_key ); ?>" value="on" tabindex="-1">
